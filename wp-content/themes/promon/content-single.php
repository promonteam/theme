<div class="blog-post">
    ...
    <p class="blog-post-meta"><?php the_time(get_option('date_format')); ?> <?php the_time(get_option('time_format')); ?>
        ...
        <br><?php bootstrap4_estimated_reading_time(); ?>
		<?php the_tags('<br>' . __('Tags', 'bootstrap4') . ': <span class="tag tag-pill tag-primary">', '</span> <span class="tag tag-pill tag-primary">', '</span>'); ?>
    </p>
